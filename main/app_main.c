...
static const char *TAG = "MQTT_BLE";
...
static const uint8_t char_mqtt_name[]  = "DATA BLE MQTT";
    ...
    switch (event) {
        ...
        case ESP_GATTS_WRITE_EVT:
            if (!param->write.is_prep){
                if(gatt_db_handle_table[IDX_CHAR_VAL_MQTT] == param->write.handle)
                {
                    int msg_id;
                   // esp_mqtt_client_handle_t client;
                    msg_id = esp_mqtt_client_publish(client, TOPIC_1, (char *)param->write.value, 0, 0, 0);
                    ESP_LOGI(TAG, "Data from Phone msg_id=%d", msg_id);
                }
...
static void mqtt_event_handler(void *handler_args, esp_event_base_t base, int32_t event_id, void *event_data)
{
    ...
    case MQTT_EVENT_CONNECTED:
        ...
        msg_id = esp_mqtt_client_publish(client, TOPIC_1, "data_3", 0, 1, 0);
        ...
        msg_id = esp_mqtt_client_unsubscribe(client, TOPIC_1);
    ...
    case MQTT_EVENT_SUBSCRIBED:
        ...
        msg_id = esp_mqtt_client_publish(client, TOPIC_1, "data", 0, 1, 0);
        ESP_LOGI(TAG, "sent publish successful, msg_id=%d", msg_id);
        break;
